...
export default function TaskForm({ initial, clients, onSubmit, onClose }: TaskFormProps) {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 px-4">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-md p-6 flex flex-col gap-5 max-h-[90vh] overflow-y-auto">
        ...
        <div className="flex items-center justify-between">
          ...
          >
            <span className={`block w-5 h-5 bg-white rounded-full shadow transition-transform mx-0.5 ${
              needsApproval ? 'translate-x-6' : 'translate-x-0'
            }`} />
          </button>
        </div>
