...
export default function KanbanCard({ task, client, onEdit, onDelete, isDragging }: KanbanCardProps) {
  ...
  return (
    <div
      ref={setNodeRef}
      style={style}
      className={`group bg-white dark:bg-zinc-900 border border-gray-100 dark:border-zinc-800 rounded-xl p-4 flex flex-col gap-3 shadow-[0_1px_4px_rgba(0,0,0,0.06)] dark:shadow-[0_1px_4px_rgba(0,0,0,0.3)] transition-all cursor-grab active:cursor-grabbing ${
